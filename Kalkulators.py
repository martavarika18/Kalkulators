...
btn0=Button(mansLogs,text='0',padx='40',pady='20', command=lambda:btnClick(0))#funkcijai padod parametrus
...
btn10=Button(mansLogs,text='/',padx='40',pady='20', command=lambda:btnCommand('/'))
btn11=Button(mansLogs,text='*',padx='40',pady='20', command=lambda:btnCommand('*'))
btn12=Button(mansLogs,text='-',padx='40',pady='20', command=lambda:btnCommand('-'))
btn13=Button(mansLogs,text='+',padx='40',pady='20', command=lambda:btnCommand('+'))

btn14=Button(mansLogs,text='=',padx='40',pady='20', command=lambda:Equals())
btn15=Button(mansLogs,text='0',padx='40',pady='20', command=lambda:btnClick(15))
btn16=Button(mansLogs,text='C',padx='40',pady='20', command=lambda:Clear())
btn17=Button(mansLogs,text='.',padx='40',pady='20')
